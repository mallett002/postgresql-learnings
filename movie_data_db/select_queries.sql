...
/*====================================================================
   NULL VALUES, ALIASES AND CONCAT CHALLENGES
====================================================================*/
...
--2: Concatenate the first and last names of the directors,...
-- ...separated by a space, and call this new column "full_name".
